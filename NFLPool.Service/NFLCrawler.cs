...
namespace NFLPool.Service
{
    public class NFLCrawler : INFLCrawler
    {
        ...
        private const string SCORE_ROW_SELECTOR = "//section[contains(@class,'Scoreboard bg-clr-white flex flex-auto justify-between')]";
        private const string TEAMS_SELECTOR = "ScoreCell__TeamName ScoreCell__TeamName--shortDisplayName truncate db";
        private const string SCORE_SELECTOR = "ScoreCell__Score h4 clr-gray-01 fw-heavy tar ScoreCell_Score--scoreboard pl2";
